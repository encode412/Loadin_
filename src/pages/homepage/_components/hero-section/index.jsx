      ...
      <main className="relative">
        <div className="overflow-hidden bg-center bg-no-repeat bg-cover h-[670px] relative bg-homebg">
          <div className="flex flex-col px-8 md:px-10 max-w-[1184px] pt-[12rem] md:pt-40 mx-auto space-y-4 animate-slide_up ">
            ...
            <span className="font-medium text-[#eee] text-lg md:text-xl w-full md:w-1/2 z-50">
            ...
            <Button
              ...
              border="none"
              borderRadius="20px"
              className="w-fit font-medium transition-colors delay-200 ease-in-out hover:!bg-[#131a53] text-xs md:text-base z-50"
              padding={"10px 20px"}
            />
          </div>
        </div>
